...
const CircularProgress = ({
    ...
    /* when the ring's border widths are different and percent is less than 50, then we need an offsetLayer
     * before the original offset layer to avoid ring color of the thick portion to be visible in the background.
     */
    ...
    return (
        <>
            ...
            <View style={[styles.container, { width: radius * 2, height: radius * 2 }]}>
                {/* to handle overflow of the radial gradient */}
                <View style={[styles.container, {
                    ...
                    <RadialGradient
                        ...
                        colors={['#002AFF', '#66D4F1', '#66D4F1', '#002AFF']}
                        stops={[0.1, 0.3, 0.4, 0.6, 0.75]}
